...
if L then
	...
	L.crush_message = "%2$dx |4Сокрушение:Сокрушения:Сокрушений; на |3-5(%1$s)"
...
if L then
	...
	L.bolt_message = "%2$dx |4Стрела:Стрелы:Стрел; на |3-5(%1$s)"
...
if L then
	...
	L.sunder_message = "%2$dx |4Раскол:Раскола:Расколов; на |3-5(%1$s)"
