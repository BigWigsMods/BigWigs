...
L:RegisterTranslations("zhTW", function() return {
	...
	overrun = "Overrun",
	overrun_desc = "當厄運行者發動 Overrun 技能時發出警報",
	overrun_trigger = "^Doomwalker.-Overrun",
	overrun_message = "Overrun!",
	overrun_soon_message = "可能發動 Overrun！",
	overrun_bar = "Overrun 冷卻",

	earthquake = "地震",
	earthquake_desc = "當厄運行者發動地震技能時發出警報",
	earthquake_message = "地震！ 70 秒後再次發動！",
	earthquake_bar = "地震 冷卻",
	earthquake_trigger = "你受到地震",
