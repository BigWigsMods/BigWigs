...
if L then
	...
	L.custom_off_mist_marks_desc = "Чтобы помочь лекарям, люди с Токсичным туманом будут помечены метками %s%s%s%s%s%s%s (в этой последовательности)(не все метки могут быть использованы), требуется быть помощником или лидером."
end
