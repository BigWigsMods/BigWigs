...
if L then
	...
	L.demolisher, L.demolisher_desc = mod:SpellName(-8533), "test" --BigWigsLoader.EJ_GetSectionInfo(8533)
	...
	L.drakes_desc = "test" --select(2, BigWigsLoader.EJ_GetSectionInfo(8586))
