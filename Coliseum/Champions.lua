...
L:RegisterTranslations("koKR", function() return {
	enable_trigger = "다음 전투는 은빛십자군에서 가장 센 기사들을 상대해야 하네... 그들을 이겨야만 자신의 가치를 인정받을걸세.",
	defeat_trigger = "상처뿐인 승리로군.",

	["Shield on %s!"] = "기사 무적: %s!",
	["Bladestorming!"] = "전사 칼날폭풍!",
	["Hunter pet up!"] = "냥꾼 야수 소환!",
	["Felhunter up!"] = "흑마 지옥사냥개 소환!",
	["Heroism on champions!"] = "용사들 영웅심!",
	["Bloodlust on champions!"] = "용사들 피의 욕망!",	
} end)
