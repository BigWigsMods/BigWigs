local L = BigWigs:NewBossLocale("Kurinnaxx", "itIT")
...
local L = BigWigs:NewBossLocale("Buru the Gorger", "itIT")
if L then
	L.bossName = "Buru il Bramacarne"

	L.fixate = "Ossessione"
	L.fixate_desc = "Prende di mira il bersaglio, ignorando le provocazioni degli altri attaccanti."
end

local L = BigWigs:NewBossLocale("Ayamiss the Hunter", "itIT")
if L then
	L.bossName = "Ayamiss il Cacciatore"
end

local L = BigWigs:NewBossLocale("Ossirian the Unscarred", "itIT")
if L then
	L.bossName = "Ossirian l'Indomito"

	L.debuff = "Debolezza"
	-- L.debuff_desc = "Warn for various weakness types."
end

local L = BigWigs:NewBossLocale("Ruins of Ahn'Qiraj Trash", "itIT")
if L then
