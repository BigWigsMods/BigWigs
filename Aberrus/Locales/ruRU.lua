...
if L then
	...
	L.zaqali_aide_north_emote_trigger = "южное укрепление" -- |TInterface\\ICONS\\Ability_Hunter_KillCommand.blp:20|t Помощники вождя поднимаются на южное укрепление!
	L.zaqali_aide_south_emote_trigger = "северное укрепление" -- |TInterface\\ICONS\\Ability_Hunter_KillCommand.blp:20|t Помощники вождя поднимаются на северное укрепление!
