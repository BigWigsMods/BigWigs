local L = BigWigs:NewBossLocale("Kazzara, the Hellforged", "esMX")
if not L then return end
if L then
	--L.dread_rift = "Rift" -- Singular Dread Rift
end

L = BigWigs:NewBossLocale("The Amalgamation Chamber", "esMX")
if L then
...
if L then
	...
	--L.zaqali_aide_message = "%s Climbing %s!" -- e.g., Big Adds Climbing NORTH!
