...
local timersTable = {
	[14] = { -- 5:44
		[397134] = { 8.8, 43.8, 47.5, 43.7, 43.7, 46.2, 43.7, 43.6 }, -- Pillars
		[374038] = { 41.8, 69.3, 66.8, 65.6, 66.8 }, -- Axes
		[371624] = { 17.3, 71.8, 46.2, 44.9, 42.5, 45.0, 44.9 }, -- Marks
		[373059] = { 61.1, 148.2 }, -- Blizzard
	},
	[15] = {
