...
function mod:OnEnable()
	self:AddCombatListener("SPELL_CAST_SUCCESS", "VoidZone", 28863)
	self:AddCombatListener("SPELL_CAST_SUCCESS", "Meteor", 28884)
	self:AddCombatListener("SPELL_CAST_SUCCESS", "Wrath", 28883)
