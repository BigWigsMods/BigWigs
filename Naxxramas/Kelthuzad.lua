...
L:RegisterTranslations("deDE", function() return {
	...
	start_warning = "Kel'Thuzad gestarted! ~3mins 30seks, bis er aktiv wird!",
	start_bar = "Phase 2",
	...
	phase3_warning = "Phase 3, Wächter in ~15sek!",
	...
	frostblast_soon_message = "Möglicher Frostschlag in ~5sek!",
	...
	detonate_warning = "Detonierendes Mana in 5sek!",
	...
	guardians_warning = "Wächter in ~10sek!",
