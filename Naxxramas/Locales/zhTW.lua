...
L = LibStub("AceLocale-3.0"):NewLocale("Big Wigs: Gluth", "zhTW")
if L then
...
L = LibStub("AceLocale-3.0"):NewLocale("Big Wigs: Patchwerk", "zhTW")
if L then
	L.enragewarn = "5 % - 狂亂！"
...
L = LibStub("AceLocale-3.0"):NewLocale("Big Wigs: Maexxna", "zhTW")
if L then
...
L = LibStub("AceLocale-3.0"):NewLocale("Big Wigs: Sapphiron", "zhTW")
if L then
...
L = LibStub("AceLocale-3.0"):NewLocale("Big Wigs: Thaddius", "zhTW")
if L then
	L.phase = "階段"
	L.phase_desc = "當進入不同階段時發出警報。"
