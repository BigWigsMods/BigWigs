...
if L then
	L.bossName = "Os Quatro Cavaleiros"
...
L = BigWigs:NewBossLocale("Patchwerk", "ptBR")
if L then
	L.bossName = "Retalhoso"
end

L = BigWigs:NewBossLocale("Instructor Razuvious", "ptBR")
if L then
	L.bossName = "Instrutor Razúvio"
