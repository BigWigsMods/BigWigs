...
mod:SetAuraData({
	...
	{1258901, soundOnApplied = "warning", difficulty = "mythic"}, -- Water Jet
	...
	{1260637, soundOnApplied = "none", soundOnAppliedDose = "none", difficulty = "mythic", note = CL.tank_debuff}, -- Water Jet (Vulnerability)
})
