...
if L then
--@localization(locale="ruRU", namespace="HellfireCitadel/Socrethar", format="lua_additive_table", handle-unlocalized="ignore")@
end
...
if L then
--@localization(locale="ruRU", namespace="HellfireCitadel/TyrantVelhari", format="lua_additive_table", handle-unlocalized="ignore")@
end
