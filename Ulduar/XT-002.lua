...
L:RegisterTranslations("zhCN", function() return {
	...
	tantrum = "发脾气",
	tantrum_desc = "当困难模式 XT-002拆解者施放发脾气时发出警报。",
	tantrum_message = "发脾气！",
	tantrum_bar = "<发脾气 冷却>",
...
L:RegisterTranslations("zhTW", function() return {
	...
	gravitybomb = "重力彈",
	gravitybomb_desc = "當玩家中了重力彈時發出警報。",
...
L:RegisterTranslations("ruRU", function() return {
	...
	exposed_desc = "Сообщать, когда XT-002 обнажает сердце.",
	exposed_warning = "Скоро сердце станет уязвимо!",
	exposed_message = "Сердце уязвимо!",

	gravitybomb = "Гравитационная бомба",
	gravitybomb_desc = "Сообщать об игроках с гравитационной бомбой.",
	...
	lightbomb_desc = "Сообщать об игроках со светлым взрывом.",
	lightbomb_you = "Взрыв на ВАС!",
	lightbomb_other = "Взрыв на |3-5(%s)!",

	heartbreak = "Разрыв сердца",
	heartbreak_desc = "Сообщать, когда XT-002 получает разрыв сердца",
	heartbreak_message = "Разрыв сердца!",
	
	tantrum = "Раскаты ярости",
	tantrum_desc = "Сообщать, когда XT-002 в сложном режиме, применяет Раскаты ярости",
