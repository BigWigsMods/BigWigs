...
if L then
	-- L.sentry = "Tank Add"
	-- L.materium = "Adds pequeños"
	-- L.shield = "Escudo" -- Global locale canidate?
end
...
if L then
	--L.traps = "Trampa de estasis" -- Stasis Trap
	--L.sparknova = "Chispanova de hiperluz" -- Hyperlight Sparknova
	--L.relocation = "Bomba de tank" -- Glyph of Relocation
	--L.relocation_count = "%s S%d (%d)" -- Bomba de tank S1 (1) // Bomba de tank (stage)(count)
	--L.wormholes = "Ruptura dimensional" -- Interdimensional Wormholes
	--L.wormhole = "Ruptura dimensional" -- Interdimensional Wormhole
	--L.rings = "Anillos S%d" -- Anillos S1 // Anillos genesiacos Stage 1/2/3/4
end

L = BigWigs:NewBossLocale("Dausegne, the Fallen Oracle", "esES")
if L then
	--L.staggering_barrage = "Barrera" -- Staggering Barrage
	--L.domination_core = "Add" -- Domination Core
	--L.obliteration_arc = "Arco" -- Obliteration Arc

	--L.disintergration_halo = "Anillos" -- Disintegration Halo
	--L.rings_x = "Anillos x%d"
	--L.rings_enrage = "Anillos (Enrage)"
	--L.ring_count = "Anillo (%d/%d)"
...
if L then
	...
	--L.windswept_wings = "Alas"
	--L.wild_stampede = "Estampida"
	--L.withering_seeds = "Semillas"
