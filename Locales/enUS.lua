...
L.settings_export_countdown_desc = "Export the general countdown settings such as size, font, etc.\nThis does not include what voice is selected, only the visual settings."
L.colors_import_bars_desc = "Import the colors of the bars."
L.colors_import_messages_desc = "Import the colors of the messages."
L.colors_import_countdown_desc = "Import the colors of the countdown."
L.colors_export_bars_desc = "Export the colors of the bars."
L.colors_export_messages_desc = "Export the colors of the messages."
L.colors_export_countdown_desc = "Export the colors of the countdown."
