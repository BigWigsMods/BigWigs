...
L.anchors = "Position"
L.settings = "Settings"
L.anchors_import_bars_desc = "Import the position (anchors) of the bars."
L.anchors_import_messages_desc = "Import the position (anchors) of the messages."
L.anchors_export_bars_desc = "Export the position (anchors) of the bars."
L.anchors_export_messagess_desc = "Export the position (anchors) of the messages."
...
L.colors_import_bars_desc = "Import the general bar color options."
L.colors_export_messages_desc = "Export the general message color options."
