...
L["Show bossmod chat messages"] = true
L["Big Wigs and other bossmod addons have the option to broadcast messages to the group over chat. By default these messages are blocked from being shown in your chatframe and on screen. You can turn on these messages using this option.\n\n|cffff4411Turning this option on can result in lots of duplicate message spam and is not recommended.|r"] = true
...
L["Broadcast"] = true
L["Broadcast all messages from Big Wigs to the raid warning channel.\n\n|cffff4411In raids this only applies if you're promoted, but in parties it will work regardless.|r"] = true
L["Raid channel"] = true
