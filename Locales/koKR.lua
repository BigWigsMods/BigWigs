...
L.altpower = "보조 자원 표시"
L.altpower_desc = "보조 자원 창을 표시합니다, 자신의 파티/공격대원의 보조 자원 수치를 표시합니다."
L.infobox = "정보 상자"
...
L.adds = "추가 몹"
L.adds_desc = "보스 전투 중 생성되는 다양한 추가 몹들과 관련된 기능들을 사용 가능하게 합니다."
L.health = "체력"
...
L.compartmentMenu_desc = "이 옵션을 끄면 미니맵에 BigWigs 아이콘이 애드온 묶음에 표시됩니다. 이 옵션을 켜두는 것을 권장합니다."
L.configure = "구성"
...
L.gitHubDesc = "|cFF33FF99BigWigs은 GitHub에 호스트되는 오픈 소스 소프트웨어입니다. 우리는 우리를 도와줄 새로운 사람들을 항상 찾고 있으며 우리의 코드를 누구나 살펴보는 것을 환영합니다, 기고를 만들고 오류 보고를 제출하세요. BigWigs은 현재 게임 커뮤니티로부터 큰 도움을 받고 있습니다.|r"
...
L.ALTPOWER = "보조 자원 표시"
L.ALTPOWER_desc = "몇몇 보스 전투는 파티 내의 플레이어에게 보조 자원 원리를 사용합니다. 보조 자원 표시는 최소/최대 보조 자원을 가진 사람을 간략하게 보여줍니다, 특정 공략이나 전술에 유용할 수 있습니다."
L.TANK = "방어 전담만"
