...
L.getNewRelease = "당신의 BigWigs는 구버전이지만 (/bwv) Curse 클라이언트를 사용해 쉽게 업데이트할 수 있습니다. 또는 curse.com이나 wowinterface.com에서 직접 업데이트할 수 있습니다."
...
L.warnSeveralReleases = "|cffff0000당신의 BigWigs는 최신 버전보다 여러번 앞서 배포된 구버전입니다!! 다른 플레이어와 동기화 문제를 방지하기 위해 업데이트를 강력히 권장합니다!|r"
