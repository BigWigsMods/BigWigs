...
L["PING"] = "미니맵 표시"
L["EMPHASIZE"] = "강조"
L["MESSAGE_desc"] = "Big Wigs에서 기술에 대하여 게임 화면에 메세지를 표시합니다. 만약 옵션에서 체크를 해제하면 표시하지 않습니다. 일부 설정은 '설정...'을 통하여 하실수 있습니다."
L["BAR_desc"] = "일부 기술에 대하여 적절한 바를 생성하여 표시합니다. 만약 옵션에서 체크를 해제하면 표시하지 않습니다. 일부 설정은 '설정...'을 통하여 하실수 있습니다."
