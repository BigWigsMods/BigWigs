...
L.guildRelease = "당신은 길드에서 만든 %d 버전의 BigWigs를 사용하고 있습니다. %d 버전 공식 애드온에서 기반하였습니다."
...
L.warnOldBase = "당신은 길드 버전의 BigWigs(%d) 를 사용하고 있지만, 당신의 기본 버전 (%d) 은 %d번 뒷쳐져 있습니다. 문제가 발생할 수 있습니다."
