...
L.logcheck_one = "|cffff0000경고!|r 당신의 전투로그 문제로 작동되지 않을 경우가 있습니다. 이것은 블리자드의 버그이며, 그 전투 로그에 따라 Recount, Big Wigs등은 로그를 이용하기 때문에 정상적인 작동이 되지 않을수 있습니다."
L.logcheck_two = "|cff33ff99대응법:|r 당신이 만약 전투로그에 의존하는 애드온을 사용해야 한다면 와우를 재접속 하기를 바랍니다."
