...
-- Auto Player Choice
L.autoPlayerChoice = "자동 플레이어 선택"
L.autoPlayerChoice_delve_power_desc = "구렁에서 몹이 떨군 플레이어 추가 능력을 자동으로 선택합니다."
L.autoPlayerChoice_notice = "자동 선택 중: %s"
...
L.messageOnOtherNote = "이 능력이 다른 사람에게 적용되었을 때 표시되는 메시지"
L.messageTauntNowNote = "탱커일 때 도발이 필요할 때 표시되는 메시지"
...
L.debuffFailureMoveFromCastNote = "|cFFFFFFFF%s|r 시전 범위에서 벗어나지 못하면 이 디버프가 적용됨" -- This debuff will apply to you if you fail to move out of the SPELL_NAME cast
L.debuffFailureGroupSoakNote = "당신의 파티가 |cFFFFFFFF%s|r 흡수하는 데 실패하면 이 디버프가 적용됨" -- This debuff will apply to you if your group fails to soak SPELL_NAME
L.debuffFailureSafeZoneNote = "안전 구역에 서 있지 못하면 이 디버프가 적용됨"
L.debuffHitByOtherPlayerNote = "다른 플레이어의 |cFFFFFFFF%s|r 맞으면 이 디버프가 적용됨" -- This debuff will apply to you if you are hit by another player's SPELL_NAME
L.debuffTargetedNote = "|cFFFFFFFF%s|r 표적이 되면 이 디버프가 적용됨" -- This debuff will apply to you if you are being targeted for SPELL_NAME
...
L.debuffDotAfterCastNote = "이 디버프는 |cFFFFFFFF%s|r 시전 후 지속 피해를 주는 효과" -- This debuff is a damage over time effect after the SPELL_NAME cast
L.debuffPossibleAfterCastNote = "이 디버프는 |cFFFFFFFF%s|r 시전 후 당신에게 적용될 수 있음" -- This debuff might apply to you after the SPELL_NAME cast
L.debuffTankAfterCastNote = "|cFFFFFFFF%s|r 시전 후 이 디버프가 탱커에게 적용" -- This debuff will apply to the tank after the SPELL_NAME cast
L.debuffGroupAfterCastNote = "|cFFFFFFFF%s|r 시전 후 파티 전체에 이 디버프가 적용" -- This debuff will apply to the entire group after the SPELL_NAME cast
...
L.debuffPickupNote = "|cFFFFFFFF%s|r” 주우면 이 디버프가 적용됨" -- This debuff will apply to you if you pick up the OBJECT_NAME
...
L.winds = "바람" -- Short for any ability with the name "Winds" in it e.g. "Winds of Change" (381517)
