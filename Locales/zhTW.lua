...
L["There are people in your group with older versions or without Big Wigs. You can get more details with /bwv."] = "在你群組裡的人使用舊版或是沒有用Big Wigs。你可以獲得更多細節用/bwv。"
L["Up to date:"] = "目前："
L["Out of date:"] = "過期："
...
L["Thanks to the following for all their help in various fields of development"] = "感謝以下他們所有的幫助在各個領域的發展"
