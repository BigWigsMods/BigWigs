...
L.addOnLoadFailedWithReason = "BigWigs 無法載入 |cFF436EEE%s|r 模組，原因是 %q；請通知 BigWigs 開發組！"
L.addOnLoadFailedUnknownError = "BigWigs 在載入模組 |cFF436EEE%s|r 的過程中發生錯誤。請通知 BigWigs devs 開發組！"
