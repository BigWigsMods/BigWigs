...
L.messagesOptInHeaderOff = "首領模組訊息「手動啟用」模式：啟用此選項，會使所有首領模組的訊息預設為「停用」。\n\n你必須逐一進入各個模組，手動開啟你想要顯示的訊息。\n\n"
L.messagesOptInHeaderOn = "首領模組訊息目前處於|cFF33FF99「手動啟用」模式|r。若要顯示特定首領模組的訊息，請進入該首領技能的設定，並開啟「|cFF33FF99訊息|r」選項。\n\n"
L.messagesOptInTitle = "首領模組訊息「手動啟用」模式"
L.messagesOptInWarning = "|cffff4411警告！|r\n\n啟用「手動啟用」後，所有首領模組訊息將會預設關閉。你必須逐一手動設定，啟用你需要的訊息。\n\n你的介面即將重新載入，確定要啟用嗎？"
