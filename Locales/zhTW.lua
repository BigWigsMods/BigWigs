...
L.requestAddonProfile = "插件「|cFF436EEE%s|r」剛才匯出了「|cFF33FF99%s|r」設定檔的字串。"
...
L.disabledAddOn = "|cFF436EEE%s|r 模組已被禁用，無法顯示計時器。"
...
L.primary_aura_spellId = "\n|cFFFFFF99主要法術 ID: %d|r"
L.secondary_aura_spellIds = "|cFFFFFF99次要法術 ID(s): %s|r"
...
L.expansion_dungeons_section = "版本地城"
L.seasonal_dungeons_section = "賽季地城"
L.confirm_import_addon_boss_settings = "插件 |cFF436EEE「%s」|r想要更改下列區域中的首領設定\n\n|cFFFFFF99%s|r\n\n這些改動會套用到 BigWigs 的\n\n|cFF33FF99「%s」|r\n\n設定檔，是否允許更改？"
...
L.mythic_flex = "彈性傳奇" -- Mythic (Flexible 15-25 player raids)
L.world = "世界" -- World (The first difficulty for Lairs in Retail WoW, essentially the same as LFR since its World -> Normal -> Heroic -> Mythic)
...
L.keystoneShortName_KingsRest = "諸王"
L.keystoneShortName_TempleOfSethraliss = "神廟"
L.keystoneShortName_RubyLifePools = "晶紅"
L.keystoneShortName_TheBlindingVale = "谷地"
L.keystoneShortName_VoidscarArena = "競技場"
L.keystoneShortName_DenOfNalorakk = "納羅"
L.keystoneShortName_MurderRow = "兇殺路"
...
L.keystoneShortName_KingsRest_Bar = "諸王"
L.keystoneShortName_TempleOfSethraliss_Bar = "神廟"
L.keystoneShortName_RubyLifePools_Bar = "晶紅"
L.keystoneShortName_TheBlindingVale_Bar = "谷地"
L.keystoneShortName_VoidscarArena_Bar = "競技場"
L.keystoneShortName_DenOfNalorakk_Bar = "納羅"
L.keystoneShortName_MurderRow_Bar = "兇殺路"
...
L.theOtherTankDesc = "顯示團隊中除你之外的第一名坦克所受到的首領減益效果。（目前：%s）"
...
L.auraSounds = "光環音效"
L.addAuraSpell = "添加法術"
L.addAuraSpellDesc = "可以是法術名稱或法術 ID；戰鬥記錄中的法術 ID 是最好的。"
L.invalidSpell = "無效法術"
L.bossDebuffsOnYou = "你：首領光環"
L.bossDebuffsOnTank = "坦克：首領光環"
L.showCountText = "顯示層數"
L.cooldownText = "倒數文字"
--L.countText = "Applications"	-- 這詞條怎麼跟原意完全不相關?
L.selectPlayer = "選擇玩家"
L.myself = "自己"
--L.trigger = "Trigger"
L.remove = "移除"
L.auraCountdownDesc = "啟用後，會在光環結束前 3 秒開始播放語音倒數。"
