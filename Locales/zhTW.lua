...
L.spellIndicatorsPosition = "法術指示器位置"
L.spellIndicatorsPositionDesc = "選擇法術指示器在技能條上的顯示位置。"
L.spellIndicatorsOffset = "法術指示器偏移"
...
L.showDispelTypeDesc = "如果在私有光環框體上有驅散類型，則顯示一個圖示。\n\n|cffffd200注意：這是對所有私有光環框體的全局設置。|r"
L.iconSize = "圖示尺寸"
L.iconSpacing = "圖示間距"
L.showCooldown = "顯示冷卻轉圈"
L.showCooldownText = "顯示冷卻文字"
L.cooldownTextScale = "冷卻文字縮放"
L.growthDirection = "圖示增長方向"
L.aurasOnYou = "你身上的光環"
L.aurasOnYouDesc = "自定義你身上的光環圖示。\n\n"
L.aurasOnAnother = "其他玩家身上的光環"
L.aurasOnAnotherDesc = "選擇一名特定玩家，然後為該玩家自定義光環圖示。\n\n"
L.chooseAPlayer = "選擇一名玩家"
L.theOtherTank = "自動尋找坦克"
L.theOtherTankDesc = "在你隊伍中除你之外的第一位坦克的私有光環。（當前：%s）"
L.playerInYourGroup = "你隊伍中的玩家"
L.maxIcons = "最大圖示數"
L.maxIconsDesc = "顯示圖示的最大數量。"
L.privateAurasHelpTip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|tBigWigs：現在您可以顯示自己的私有光環減益圖示，甚至還可以顯示其他玩家（例如坦克）的私有光環。"
...
L.blizzWarningsAsBigWigsMessages = "使用 BigWigs 訊息取代暴雪內建首領警告"
L.blizzWarningsAsBigWigsMessagesDesc = "將所有暴雪內建的首領警告訊息替換為 BigWigs 的訊息風格"
