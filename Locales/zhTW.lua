...
-- L.testNameplateBarsBtn = "Create Test Nameplate Bar"
-- L.testNameplateBarsBtn_desc = "Creates a nameplate bar on your current target for you to test your current display settings with."
