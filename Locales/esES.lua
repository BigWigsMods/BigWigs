...
L["There is a new release of Big Wigs available. You can visit curse.com, wowinterface.com, wowace.com or use the Curse Updater to get the new release."] = "Existe una nueva versión de Big Wigs disponible. Puedes visitar curse.com, wowinterface.com, wowace.com o usar el cliente de Curse para adquirirla."
...
L.coreAddonDisabled = "Big Wigs no puede funcionar debidament ya que el addon %s está desactivado. Puedes activarlo desde el addon Control panel o en la pantalla de selección de personaje."

-- Options.lua
L["Big Wigs Encounters"] = "Big Wigs Encounters"
L["Customize ..."] = "Personalizar..."
L["Profiles"] = "Perfiles"
L.introduction = "Bienvenido al Big Wigs. Ponte rápidamente el cinturón, come cacahuetes y disfruta del paseo. De manera no intrusiva le preparará para ese nuevo encuentro de jefe como en una cena de siete platos para su grupo de raid."
...
L["Sound"] = "Sonido"
L.soundDesc = "Los mensajes podrían llegar con un sonido. A algunas personas les resulta más fácil cuando escucharlo cuando aprenden que el sonido va con que mensaje, en contraposición a la lectura del mensaje actual. \n\n|cffff4411Incluso cuando está apagado, el sonido por defecto de aviso de raid será usado para avisar a los otros jugadores. Este sonido, sin embargo, es diferente de los sonidos que usamos.|r"
