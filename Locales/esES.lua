...
L.primary_aura_spellId = "\n|cFFFFFF99ID del hechizo principal: %d|r"
L.secondary_aura_spellIds = "|cFFFFFF99ID del hechizo secundario(s): %s|r"
...
L.spellNameResetDesc = "Esta habilidad tiene un nombre personalizado por defecto, haz clic en este botón para usar el nombre original (normalmente un nombre de hechizo)."
...
L.sharing_auras_desc = "Importar los sonidos de aura configurados."
...
L.world = "Mundo" -- World (The first difficulty for Lairs in Retail WoW, essentially the same as LFR since its World -> Normal -> Heroic -> Mythic)
...
L.bossStagesTimerDesc = "Un temporizador que se reinicia cada vez que un jefe cambia de fase, con un tooltip para ver el historial de etapas. Solo está activo en jefes con múltiples etapas."
L.bossStagesTimerTooltip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|tHistorial de etapas del jefe"
L.instanceTimer = "Temporizador de estancia"
L.instanceTimerDesc = "Un temporizador que muestra cuánto tiempo has estado en una estancia (mazmorra/banda/etc.), con un tooltip para ver el historial de la estancia."
L.instanceTimerTooltip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|tHistorial de estancias"
...
L.enteringDungeon = "Entrando en una mazmorra"
...
L.keystoneShortName_MaisaraCaverns = "CAVERNAS"
...
L.keystoneShortName_RubyLifePools = "ESTANQUES"
L.keystoneShortName_TheBlindingVale = "VALLE"
L.keystoneShortName_VoidscarArena = "ARENA"
L.keystoneShortName_DenOfNalorakk = "GUARIDA"
L.keystoneShortName_MurderRow = "FRONTAL"
...
L.keystoneShortName_KingsRest_Bar = "Reposo"
L.keystoneShortName_TempleOfSethraliss_Bar = "Sethraliss"
L.keystoneShortName_RubyLifePools_Bar = "Estanques"
L.keystoneShortName_TheBlindingVale_Bar = "Valle"
L.keystoneShortName_VoidscarArena_Bar = "Lacravacua"
L.keystoneShortName_DenOfNalorakk_Bar = "Guarida"
...
L.showDispelTypeDesc = "Mostrar icono si el aura es disipable."
L.dispelType = "Indicador del tipo de disipación."
...
L.aurasOnYouDesc = "Personaliza los iconos para las auras que se te aplican.\n\n"
L.aurasOnAnother = "Auras sobre otro"
L.aurasOnAnotherDesc = "Elige un jugador específico y luego personaliza los iconos para las auras que se le aplican.\n\n"
...
L.showCountText = "Mostrar acumulaciones"
L.cooldownText = "Duración de enfriamiento"
L.countText = "Usos"
L.selectPlayer = "Elegir jugador"
L.myself = "A mí mismo"
L.trigger = "Activar"
L.remove = "Quitar"
L.auraCountdownDesc = "Si está activado, se añade un contador por voz para los 3 últimos segundos del aura."
L.auraDuration = "Duración del aura"
L.auraDurationDesc = "La duración en segundos de cuánto va a durar el aura."
...
L.borderDispelColor = "Borde con el color del tipo de disipación"
...
L.onyou = "Un hechizo, beneficio o debuff te afecta"
