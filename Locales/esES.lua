...
L.confirm_export_disabled_plugin = "Tienes |cFF33FF99\"%s\"|r desactivado.\n\nCuando lo exportes esta opción estará desactivada para quien importe esta cadena, |cffff8000incluso aunque quieran usarlo.|r.\n\n¿Estás seguro de querer hacer esto?"
L.confirm_import_disabled_plugin = "La configuración que estás a punto de importar tiene desactivado |cFF33FF99\"%s\"|r.\n\nImportarlo te lo desactivará a ti también.\n\n¿Estás seguro de querer hacer esto?"
