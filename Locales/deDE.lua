...
L["|cffff0000There are people in your group with\nolder versions or without Big Wigs.\nYou can get more details with /bwv.|r"] = "|cffff0000Es gibt Leute in deiner Gruppe mit\nveralteter Version oder ohne Big Wigs.\nMehr Details mit /bwv.|r"
L["|cff00ff00Everyone is running an up-to-date Big Wigs.|r"] = "|cff00ff00Jeder benutzt ein aktuelles Big Wigs.|r"
