...
L.alphaRelease = "Bei dir läuft ein ALPHA RELEASE von Big Wigs %s (%s)."
...
L.norm25 = "25"
L.normal = "Normal"
L.officialRelease = "Bei dir läuft ein offizieller Release von Big Wigs %s (%s)."
L.offline = "Offline"
...
L.zoneMessagesDesc = "Wenn Du diese Option deaktivierst, zeigt Big Wigs beim Betreten von Gebieten ohne installierte Bossmods keine Meldungen mehr an. Es wird empfohlen, diese Option aktiviert zu lassen, da sie über neu erstellte Timer für neue Gebiete informiert."
