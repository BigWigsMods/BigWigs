...
L.keystoneExplainer = "Eine Sammlung verschiedener Werkzeuge zur Verbesserung der Mythic+ Erfahrung."
...
L.keystoneAutoSlotMessage = "%s wurde autommatisch in den Born der Macht eingesetzt."
...
L.keystoneHideGuildDesc = "|cffff4411Nicht empfohlen.|r Diese Funktion verhindert die Anzeige Deines Schlüsselsteins für die Gildenmitglieder. Jedes Mitglied der Gruppe kann diesen weitehrin sehen."
