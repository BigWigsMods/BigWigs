...
L.add_spawning = "增援将至" -- singular
L.adds_spawning = "增援将至" -- plural
L.add_incoming = "增援来袭" -- singular
L.adds_incoming = "增援来袭" -- plural
L.spawned = "%s已刷新"
L.spawning = "%s将至"
L.next_add = "下一只增援"
...
L.eat_adds = "吞噬增援" -- When a boss is going to eat/consume any adds remaining to empower/heal itself. Usually this is a timer. You have to kill all adds in X seconds or they will be eaten.
...
L.messageOnOtherNote = "技能施放给他人时显示的信息"
L.messageTauntNowNote = "身为坦克需要嘲讽时显示的信息"
...
L.pull_in = "拖拽" -- An ability that pulls you in towards the boss against your will
