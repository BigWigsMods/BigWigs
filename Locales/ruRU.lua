...
L.requestAddonProfile = "Аддон '|cFF436EEE%s|r' создал копию строки экспорта Вашего профиля для профиля с именем |cFF33FF99'%s'|r."
...
L.primary_aura_spellId = "Основное заклинание ID: %d"
L.secondary_aura_spellIds = "Вторичное/ые заклинание/я ID: %s"
--L.auraDispelType = "Dispel type: %s"
L.auraDispel_magic = "Магия"
L.auraDispel_curse = "Проклятие"
L.auraDispel_disease = "Болезнь"
L.auraDispel_poison = "Яд"
L.auraDispel_bleed = "Кровотечение"
--L.auraMechanic = "Mechanic: %s"
L.auraMechanic_charmed = "Подчинение"
L.auraMechanic_disoriented = "Дезориентация"
L.auraMechanic_disarmed = "Без оружия"
L.auraMechanic_distracted = "Отвлечение"
L.auraMechanic_fleeing = "Паника"
L.auraMechanic_knockbacked = "Отбрасывание"
L.auraMechanic_rooted = "Обездвиживание"
L.auraMechanic_slowed = "Замедление"
L.auraMechanic_silenced = "Немота"
L.auraMechanic_asleep = "Сон"
L.auraMechanic_snared = "Сковывание"
L.auraMechanic_stunned = "Оглушение"
L.auraMechanic_frozen = "Заморозка"
L.auraMechanic_incapacitated = "Паралич"
L.auraMechanic_bleeding = "Кровотечение"
L.auraMechanic_healing = "Лечение"
L.auraMechanic_polymorphed = "Превращение"
L.auraMechanic_banished = "Изгнание"
L.auraMechanic_shielded = "Защита"
L.auraMechanic_shackled = "Оковы"
L.auraMechanic_mounted = "Верхом"
L.auraMechanic_infected = "Заражение"
L.auraMechanic_turned = "Обращение"
L.auraMechanic_horrified = "Ужас"
L.auraMechanic_invulnerable = "Неуязвимость"
L.auraMechanic_interrupted = "Прерывание"
L.auraMechanic_dazed = "Головокружение"
L.auraMechanic_discovery = "Открытие"
L.auraMechanic_sapped = "Ошеломление"
L.auraMechanic_enraged = "Исступление"
L.auraMechanic_wounded = "Ранение"
L.auraMechanic_taunted = "Провокация"
...
L.export = "Экспорт"
L.export_core = "Экспорт общих настроек"
...
L.expansion_dungeons_section = "Подземелья дополнения"
L.seasonal_dungeons_section = "Сезонные подземелья"
L.confirm_import_addon_boss_settings = "Аддон |cFF436EEE\"%s\"|r хочет автоматически изменять Ваши настройки боссов BigWigs для всех боссов в следующих разделах:\n\n|cFFFFFF99%s|r\n\nЭто применится к следующему профилю:\n\n|cFF33FF99\"%s\"|r\n\nВы уверены, что хотите это сделать?"
...
L.sharing_auras_desc = "Импортировать настроенные звуки аур."
...
L.world = "Ворлд-босс" -- World (The first difficulty for Lairs in Retail WoW, essentially the same as LFR since its World -> Normal -> Heroic -> Mythic)
...
L.keystoneShortName_KingsRest_Bar = "Гробница"
L.keystoneShortName_TempleOfSethraliss_Bar = "Храм"
L.keystoneShortName_RubyLifePools_Bar = "Омуты"
L.keystoneShortName_TheBlindingVale_Bar = "Долина"
L.keystoneShortName_VoidscarArena_Bar = "Арена"
L.keystoneShortName_DenOfNalorakk_Bar = "Берлога"
L.keystoneShortName_MurderRow_Bar = "Закоулок"
L.keystoneShortName_AltarOfFangs_Bar = "Алтарь"
...
L.CENTER = "По центру"
L.CENTER_HORIZONTAL = "Центрирование по горизонтали"
L.CENTER_VERTICAL = "Центрирование по вертикали"
...
L.chatFrameChoice = "Выбрать окно чата"
L.chatFrame = "Окно чата %d: %s" -- "Chat Frame 1: General" or "Chat Frame 2: Combat Log" etc.
...
L.showDispelTypeDesc = "Показывать иконку на ауре, если её можно рассеить."
L.dispelType = "Индикатор типа рассеивания"
...
L.cooldownDecimalsThreshold = "Порог десятичных чисел"
L.cooldownDecimalsThresholdDesc = "Порог в секундах, при котором начнут отображаться десятичные числа."
...
L.theOtherTankDesc = "Показывать дебаффы босса, наложенные на первого танка в вашей группе, исключая Вас самих. (Current: %s)"
...
L.aurasTestTankAnchorText = "Ауры\nТанка"

L.auraSounds = "Звуки ауры"
L.addAuraSpell = "Добавить способность"
L.addAuraSpellDesc = "Теперь Вы можете добавить способности по их названию, но рекомендуется использовать ID способности из логов."
L.invalidSpell = "Неподходящая способность"
L.bossDebuffsOnYou = "Дебаффы босса на Вас"
L.bossDebuffsOnTank = "Дебаффы босса на Танке"
L.showCountText = "Показывать стаки"
L.cooldownText = "Длительность перезарядки"
L.countText = "Накладывание"
L.selectPlayer = "Выбрать игрока"
L.myself = "На себя"
L.trigger = "Условие воспроизведения"
L.remove = "Исключить"
L.auraCountdownDesc = "Если включено, голосовое оповещение сработает на последних трёх секундах ауры."
L.auraDuration = "Длительность ауры"
L.auraDurationDesc = "Длительность ауры в секундах."
...
L.borderDispelColor = "Цвет границы от типа рассеивания"
