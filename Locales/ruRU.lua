...
L.confirm_import_addon_new_profile = "Модификация |cFF436EEE\"%s\"|r хочет создать новый профиль BigWigs с именем \n\n|cFF33FF99\"%s\"|r\n\nПринятия этих изменений переключит профиль на этот."
L.confirm_import_addon_edit_profile = "Модификация |cFF436EEE\"%s\"|r хочет отредактировать один из профилей BigWigs с именем \n\n|cFF33FF99\"%s\"|r\n\nПринятия этих изменений переключит профиль на этот."
