...
L.export_bosses_info = "Выбранные Вами боссы из списка ниже будут экспортированы."
L.raids_section = "Рейды"
L.expansion_dungeons_section = "Подземелья дополнения"
L.seasonal_dungeons_section = "Сезонные подземелья"
L.confirm_import_addon_boss_settings = "Аддон |cFF436EEE\"%s\"|r хочет автоматически изменять Ваши настройки боссов BiwWigs для всех босов в следующих разделах:\n\n|cFFFFFF99%s|r\n\nЭто применится к следующему профилю:\n\n|cFF33FF99\"%s\"|r\n\nВы уверены, что хотите это сделать?"
...
L.chatFrameChoice = "Choose Chat FrameВыбрать окно чата"
...
L.cooldownDecimalsThresholdDesc = "At which threshold in seconds should decimal points be shown.Порог в секундах, при котором начнут отображаться десятичные числа."
...
L.aurasHelpTip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|tBigWigs: Теперь вы можете видеть ваши дебаффы босса в виде иконок, а также дебаффы босса на другом игроке, например на танке."
