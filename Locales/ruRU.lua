...
L["PROXIMITY"] = "Отображение расстояния"
L["PROXIMITY_desc"] = "Способности иногда требуют от вас рассредоточиться. Отображение расстояние будет специально показываться для таких спобностей, так что вы сможете сказать с одного взгляда в безопасности вы или нет."
