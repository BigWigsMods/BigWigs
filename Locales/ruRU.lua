...
L["Pretend I'm using DBM"] = "Притвориться, что я использую DBM"
...
L["DISPEL_MAGIC"] = "Только магические рассеиватели"
L["DISPEL_MAGIC_desc"] = "Если вы хотите видеть предупреждения для таких способностей, даже если вы не умеете их рассеивать, отключите эту опцию."
L["DISPEL_ENRAGE"] = "Только рассеиватели исступления"
L["DISPEL_ENRAGE_desc"] = "Если вы хотите видеть предупреждения для таких способностей, даже если вы не умеете их рассеивать, отключите эту опцию."
