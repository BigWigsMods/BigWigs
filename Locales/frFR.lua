...
L.battleResTitle = "Résurrection de combat"
...
L.cooldownEmphasizeHeader = "Par défaut, la mise en évidence est désactivée (0 seconde).\nLa passer à 1 seconde ou plus va l'activer. Cela vous permettra de choisir une couleur et une taille de police pour ces nombres."
