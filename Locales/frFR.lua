...
L.altpower_desc = "Afficher la fenêtre de ressource alternative, qui montre la quantité de ressource alternative des membres de votre groupe."
L.infobox = "Boîte d'information"
L.infobox_desc = "Afficher une boîte d'information concernant la rencontre."
L.stages = "Phases"
...
L.proximity_desc = "Afficher la fenêtre de proximité quand cela est approprié pour cette rencontre, indiquant la liste des joueurs qui se trouvent trop près de vous."
L.adds = "Adds"
...
L.position_import_countdown_desc = "Importer la position (ancres) du compte à rebours."
...
L.settings_import_bars_desc = "Importer les paramètres généraux des barres, tels que la taille, la police, etc."
L.settings_import_messages_desc = "Importer les paramètres généraux des messages, tels que la taille, la police, etc."
L.settings_import_countdown_desc = "Importer les paramètres généraux du compte à rebours, tels que la voix, la taille, la police, etc."
L.settings_export_bars_desc = "Exporter les paramètres généraux des barres, tels que la taille, la police, etc."
L.settings_export_messages_desc = "Exporter les paramètres généraux des messages, tels que la taille, la police, etc."
L.settings_export_countdown_desc = "Exporter les paramètres généraux du compte à rebours, tels que la voix, la taille, la police, etc."
L.colors_import_bars_desc = "Importer la couleur des barres."
L.colors_import_messages_desc = "Importer la couleur des messages."
L.color_import_countdown_desc = "Importer la couleur du compte à rebours."
L.colors_export_bars_desc = "Exporter la couleur des barres."
L.colors_export_messages_desc = "Exporter la couleur des messages."
L.color_export_countdown_desc = "Exporter la couleur du compte à rebours."
...
L.privateAuras_settings_import_desc = "Importer tous les paramètres des Auras Privées."
L.privateAuras_settings_export_desc = "Exporter tous les paramètres des Auras Privées."
...
L.testBarsBtn_desc = "Créé une barre pour que vous puissiez tester vos paramètres d'affichage actuels."
...
L.blizzard_timers_desc = "Afficher les CàR de Blizzard comme des barres de BigWigs."
L.both_timers = "Les deux"
L.both_timers_desc = "Afficher les CàR de Blizzard et les CàR personnalisés en même temps. |cffff4411Pour effectuer des tests, et sur les rencontres pas encore mises à jour.|r"
