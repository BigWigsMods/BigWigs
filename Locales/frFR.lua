...
L.nameplate_settings_import_desc = "Importez tous les paramètres des barres d'infos."
L.nameplate_settings_export_desc = "Exportez tous les paramètres des barres d'infos."
L.position_import_bars_desc = "Importez la position (ancres) des barres."
L.position_import_messages_desc = "Importez la position (ancres) des messages."
L.position_import_countdown_desc = "Importez la position (ancres) du compte à rebours."
L.position_export_bars_desc = "Exportez la position (ancres) des barres."
L.position_export_messages_desc = "Exportez la position (ancres) des messages."
L.position_export_countdown_desc = "Exportez la position (ancres) du compte à rebours."
...
L.mythicplus_settings_import_desc = "Importez tous les paramètres mythique +."
L.mythicplus_settings_export_desc = "Exportez tous les paramètres mythique +."
L.imported_battleres_settings = "Paramètres Battle Rez"
L.battleres_settings_import_desc = "Importez tous les paramètres de Battle Rez."
L.battleres_settings_export_desc = "Exportez tous les paramètres de Battle Rez."
L.imported_privateAuras_settings = "Paramètres des Auras Privées"
L.privateAuras_settings_import_desc = "Importez tous les paramètres des Auras Privées."
L.privateAuras_settings_export_desc = "Exportez tous les paramètres des Auras Privées."
