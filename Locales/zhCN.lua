...
L.keystoneAutoShowEndOfRunDesc = "当史诗钥石地下城结束时自动显示钥石管理器。\n\n|cFF33FF99这可以帮助你查看队伍成员获得了哪些新钥石。|r"
L.keystoneViewerExplainer = "你可以使用|cFF33FF99/key|r 命令或点击下方按钮打开钥石管理器。\n\n"
L.keystoneViewerOpen = "打开钥石管理器"
L.keystoneViewerKeybindingExplainer = "\n\n您也可以设置一个快捷键来打开传送门管理器：\n\n"
L.keystoneViewerKeybindingDesc = "选择用于打开传送门管理器的快捷键。"
