...
L.keystoneAutoSlot = "自动插入钥石"
L.keystoneAutoSlotDesc = "打开能量之泉时，自动将你的钥石插入。"
L.keystoneAutoSlotMessage = "已将 %s 自动插入能量之泉。"
L.keystoneAutoSlotFrame = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:14:14|t 钥石已自动插入"
