...
L["PING_desc"] = "有时所在位置也很重要，Big Wigs 将点击小地图通知大家你位于何处。"
...
L["DISPEL_MAGIC"] = "只对法系驱散"
L["DISPEL_MAGIC_desc"] = "如果你想看到技能警报即使你不能驱散它，禁用此选项。"
L["DISPEL_ENRAGE"] = "只对近战打断"
L["DISPEL_ENRAGE_desc"] = "如果你想看到技能警报即使你不能打断它，禁用此选项。"
L["Advanced options"] = "高级选项"
L["<< Back"] = "<< 返回"

L.tank = "只警报坦克。"
L.healer = "只警报治疗。"
L.tankhealer = "只警报坦克和治疗。"
L.dispeller = "只警报驱散和打断。"
