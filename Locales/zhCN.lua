...
L.keystoneCountdownBeginsDesc = "选择史诗钥石的倒数计时器还剩多少时间时，开始播放倒数语音。"
L.keystoneCountdownBeginsSound = "选择史诗钥石倒数计时器开始时播放的音效"
L.keystoneCountdownEndsSound = "选择史诗钥石倒数计时器结束时播放的音效"
