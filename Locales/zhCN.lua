...
-- Core.lua
L.berserk = "狂暴"
L.berserk_desc = "为首领狂暴显示计时条和警告。"
L.altpower = "交替能量显示"
L.altpower_desc = "显示交替能量窗口，可查看团队成员的交替能量数值。"
L.infobox = "信息盒"
L.infobox_desc = "显示当前战斗相关的信息。"
L.stages = "阶段"
L.stages_desc = "启用与首领战斗阶段相关的功能，如阶段变化警告、阶段持续时间计时条等。"
L.warmup = "预备"
...
L.SAY_desc = "聊天泡泡十分醒目。BigWigs会发送一条信息到“说”频道，提醒附近玩家你身上的效果。"
...
L.TANK = "仅坦克"
L.TANK_desc = "有些技能只对坦克重要。如果你想无视职责看到这些技能的警告，请禁用此选项。"
L.HEALER = "仅治疗"
L.HEALER_desc = "有些技能只对治疗重要。如果你想无视职责看到这些技能的警告，请禁用此选项。"
L.TANK_HEALER = "仅坦克和治疗"
L.TANK_HEALER_desc = "有些技能只对坦克和治疗重要。如果你想无视职责看到这些技能的警告，请禁用此选项。"
L.DISPEL = "仅驱散"
L.DISPEL_desc = "如果你希望看到自己无法驱散的技能警告，请禁用此选项。"
L.VOICE = "语音"
L.VOICE_desc = "如果安装了语音插件，此选项可以开启并播放该警告的语音文件"
L.COUNTDOWN = "倒数"
...
L.CASTBAR = "施法条"
L.CASTBAR_desc = "部分首领战中会显示施法条，通常用于提示即将到来的关键技能。如果该技能附带了你想隐藏的施法条，请禁用此选项。"
L.SAY_COUNTDOWN = "说倒计时"
L.SAY_COUNTDOWN_desc = "聊天泡泡十分醒目。BigWigs会连续发送多条倒计时信息到“说”频道，提醒附近的玩家你身上的技能即将结束。"
...
L.PRIVATE = "私有光环"
L.PRIVATE_desc = "这些设置仅针对通用施法警报和施法条！\n\n若想更改此技能以你为目标时播放的音效，可在对应首领模块的“私有光环”中选择。"
...
L.battleResModeTextTooltip = "显示临时背景以便移动战复功能图标，并查看鼠标悬停的有效区域。"

-----------------------------------------------------------------------
-- CombatTimer.lua
--

L.combatTimerTitle = "战斗计时"
L.anyCombatTimer = "任意战斗计时"
...
L.keystoneShortName_KingsRest = "诸王"
L.keystoneShortName_TempleOfSethraliss = "神庙"
L.keystoneShortName_RubyLifePools = "红玉"
L.keystoneShortName_TheBlindingVale = "夺目谷"
L.keystoneShortName_VoidscarArena = "竞技场"
L.keystoneShortName_DenOfNalorakk = "洞穴"
L.keystoneShortName_MurderRow = "密谋"
L.keystoneShortName_AltarOfFangs = "毒牙"
...
L.keystoneShortName_KingsRest_Bar = "诸王"
L.keystoneShortName_TempleOfSethraliss_Bar = "神庙"
L.keystoneShortName_RubyLifePools_Bar = "红玉"
L.keystoneShortName_TheBlindingVale_Bar = "夺目谷"
L.keystoneShortName_VoidscarArena_Bar = "竞技场"
L.keystoneShortName_DenOfNalorakk_Bar = "洞穴"
L.keystoneShortName_MurderRow_Bar = "密谋"
L.keystoneShortName_AltarOfFangs_Bar = "毒牙"
...
L.aurasDesc = "BigWigs 可以将你身上的首领减益以图标形式显示，方便你追踪。\n|cFF33FF99这样能把关键减益与普通减益分开显示，让你更直观地掌握自身状态。|r\n\n"
L.disabledDuringTrash = "小怪期间禁用"

L.createTestAura = "创建测试光环"
L.showDispelType = "显示驱散类型指示器"
L.showDispelTypeDesc = "为可驱散的光环显示驱散类型图标。"
L.dispelType = "驱散类型指示器"
L.iconSize = "图标尺寸"
L.iconSpacing = "图标间距"
L.showCooldown = "显示冷却转圈"
L.showCooldownText = "显示冷却文本"
L.cooldownDecimalsThreshold = "显示小数阈值"
L.cooldownDecimalsThresholdDesc = "低于该秒数的冷却时间将显示小数点后位数。"
...
L.theOtherTankDesc = "显示你所在队伍中除你之外的第一名坦克的首领减益。（当前：%s）"
L.onlyWhenYouAreTank = "仅当你是坦克时显示"
L.playerInYourGroup = "你队伍中的玩家"
L.tankIndicator = "坦克指示器"
L.maxIcons = "最大图标数"
...
L.aurasHelpTip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|tBigWigs：现在您可以显示自己的首领减益图标，也可以查看其他玩家（例如坦克）的首领减益。"
...
L.wrongCustomBarFormat = "格式错误。正确用法：/raidbar 20 文本"
L.wrongTime = "指定的时间无效。<time> 可以是秒数、M:S 格式或分钟数。例如：5、1:20 或 2分钟。"

L.wrongBreakFormat = "时间必须在1至60分钟之间。正确用法：/break 5"
L.sendBreak = "正在向 BigWigs 和 DBM 用户发送休息计时。"
L.breakStarted = "%s用户%s发起了休息计时。"
L.breakStopped = "%s 取消了休息计时。"
L.breakBar = "休息计时"
L.breakMinutes = "休息计时将在 %d 分钟后结束！"
L.breakSeconds = "休息计时将在 %d 秒后结束！"
L.breakFinished = "休息计时结束！"
...
L.disableAudioDesc = "魔兽世界声音选项中的“%s”选项将被关闭，首领战斗结束后会重新打开。这有助于将注意力集中在 BigWigs 的警告音效上。"
...
L.redDesc = "一般战斗警告。"
L.blue = "蓝色"
L.blueDesc = "直接对你造成影响的警告，例如减益效果。"
L.orange = "橙色"
L.yellow = "黄色"
L.green = "绿色"
L.greenDesc = "对你有好事发生的警告，例如减益效果移除。"
L.cyan = "青色"
L.cyanDesc = "状态发生变化的警告，例如进入到下一阶段。"
L.purple = "紫色"
L.purpleDesc = "坦克特定技能的警告，例如减益效果叠加。"
...
L.resetMessagesDesc = "重置所有信息相关选项，包括信息锚点位置。"
L.toggleMessagesAnchorsBtnShow_desc = "显示所有可移动锚点，允许你调整信息显示位置。"
...
L.useIcons = "使用图标"
L.useIconsDesc = "在信息旁显示图标。"
L.classColors = "职业颜色"
L.classColorsDesc = "为信息中的玩家名字启用职业颜色。"
L.chatFrameMessages = "聊天框信息"
L.chatFrameMessagesDesc = "除了显示设置外，将所有 BigWigs 信息输出到默认聊天框。"
L.chatFrameChoice = "选择聊天框"
L.chatFrame = "聊天框 %d：%s" -- "Chat Frame 1: General" or "Chat Frame 2: Combat Log" etc.
...
L.messagesOptInHeaderOff = "信息'手动选择'模式：启用此选项将关闭所有模块的信息。\n\n您需要逐个进入每个模块的设置，手动开启您想要的信息提示。\n\n"
L.messagesOptInHeaderOn = "信息'手动选择'模式已|cFF33FF99启用|r。要查看信息，请进入特定技能的设置并开启'|cFF33FF99信息|r'选项。\n\n"
L.messagesOptInTitle = "信息'手动选择'模式"
L.messagesOptInWarning = "|cffff4411警告！|r\n\n启用'手动选择'模式将关闭所有模块的信息。您需要逐个进入每个模块的设置，手动开启您想要的信息提示。\n\n界面即将重新加载，是否继续？"
...
L.borderOffset = "边框偏移"
L.borderName = "边框材质"
L.borderDispelColor = "按驱散类型对边框着色"
L.showNumbers = "显示数字"
L.showNumbersDesc = "在图标上显示数字。"
L.cooldown = "冷却"
L.cooldownEmphasizeHeader = "默认情况下，醒目效果处于关闭状态（0秒）。设置为1秒或更高时将启用醒目效果，允许您为倒计时数字设置不同的字体颜色和尺寸。"
L.showCooldownSwipe = "显示冷却动画"
L.showCooldownSwipeDesc = "冷却期间在图标上显示顺时针旋转的动画效果。"
L.showCooldownEdge = "时针显示"
L.showCooldownEdgeDesc = "冷却期间在图标上显示指针旋转的动画效果。"
L.inverse = "反转"
L.inverseSwipeDesc = "反转冷却动画的旋转方向。"
L.glow = "发光效果"
L.enableExpireGlow = "启用冷却结束发光效果"
L.enableExpireGlowDesc = "冷却结束时在图标周围显示发光动画效果。"
L.glowColor = "发光颜色"
L.glowType = "发光样式"
...
L.soundDelay = "音效延迟"
L.soundDelayDesc = "当有人距离你过近时，设置 BigWigs 重复播放指定音效的间隔时长。"
...
L.combatLog = "自动战斗记录"
L.combatLogDesc = "开怪倒数开始时自动记录战斗日志，并在战斗结束时停止。"

L.pull = "开怪倒数"
L.engageSoundTitle = "当首领战斗开始时播放音效"
L.pullStartedSoundTitle = "当开怪倒数开始时播放音效"
L.pullStartedMessageTitle = "当开怪倒数开始时显示信息"
L.pullFinishedSoundTitle = "当开怪倒数结束时播放音效"
L.pullStartedBy = "%s 发起了开怪倒数。"
L.pullStopped = "%s 取消了开怪倒数。"
L.pullStoppedCombat = "开怪倒数因进入战斗而取消。"
L.pullIn = "%d 秒后开怪"
L.sendPull = "正在向队伍/团队发送开怪倒数。"
L.wrongPullFormat = "无效的开怪倒数。正确用法：/pull 5"
L.countdownBegins = "开始倒计时"
L.countdownBegins_desc = "选择开怪倒数还剩多少秒时开始倒计时。"
L.pullExplainer = "\n|cFF33FF99/pull|r 将开启默认开怪倒。\n|cFF33FF99/pull 7|r 将开启7秒开怪倒数，数字可任意指定。\n您也可以在下方设置快捷键。\n\n"
L.pullKeybindingDesc = "为开启开怪倒数设置快捷键。"
...
L.Alert = "警报"
L.Long = "长响"
L.Warning = "警告"  --暴雪本地化使用的 SLASH_TEXTTOSPEECH_RAID_WARNING = "团队警告";
