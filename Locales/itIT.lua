...
L.coreAddonDisabled = "Big Wigs non può funzionare correttamente perché l'addon %s e' disattivato. Puoi attivarlo nel pannello di controllo degli Addon nella schermata di login dei personaggi."
...
L["Sound"] = "Suoni"
L.soundDesc = "I messaggi possono essere dai insieme a suoni. Alcuni trovano più semplice associare il suono all'abilità che viene mostrata nel messaggio piuttosto che leggere il messaggio stesso.\n\n|cffff4411Anche quando disattivato, il suono puo' essere lanciato dai raid warning. Quel suono è comunque diverso da quello che usiamo noi.|r"
...
L["Flash"] = "Lampeggia"
L["Shake"] = "Vibra"
L.fnsDesc = "Alcune abilità sono importanti al punto da richiedere la tua piena attenzione. Quando queste abilita' vengono lanciate Big Wigs può Illuminare e far vibrare lo schermo.\n\n|cffff4411Se giochi con le barre della vita attive, la vibrazione non funziona per una limitazione della Blizzard, lo schermo lampeggia solamente.|r"
...
L["FLASHSHAKE_desc"] = "Alcune abilità sono più importanti di altre. Se vuoi che il tuo schermo lampeggi e vibri quando sta per arrivare questa abilità, abilita questa opzione."
L["ICON_desc"] = "Big Wigs può evidenziare i giocatori affetti da alcune abilità con un marchio. Questo rende più facile vederli."
L["WHISPER_desc"] = "Alcuni effetti sono talmente importanti che Big Wigs invierà un sussurro al giocatore affetto."
