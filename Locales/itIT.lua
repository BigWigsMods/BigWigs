...
L.already_registered = "|cffff0000ATTENZIONE:|r |cff00ff00%s|r (|cffffff00%s|r) esiste già come modulo di BigWigs, ma qualcosa sta cercando di caricarlo di nuovo. Questo solitamente significa che hai 2 copie di questo modulo nella cartella addons a causa di qualche aggiornamento sbagliato. È consigliabile reinstallare BigWigs cancellando tutte le cartelle BigWigs."
...
L["There are people in your group with older versions or without Big Wigs. You can get more details with /bwv."] = "Hai giocatori nel tuo gruppo con versioni obsolete di Big Wigs. Puoi avere maggiori dettagli scrivendo /bwv."
...
--L.flashDesc = "Alcune abilità sono così importanti che richiedono la tua completa attenzione. Quando awi bersagliop diretto di queste abilità Big Wigs può far lampeggiare lo schermo."
...
L.whisperDesc = "Manda un sussuro ai giocatori riguardanti alcune abilità dei boss che li colpiscono. Pensa agli effetti tipo 'bomba' che possono accadere.\n\n|cffff4411Si applica solo se sei Capo Incursione o Assistente!|r"
...
L.dbmBarDesc = "Se un'utente DMB invia un timer di ingaggio o una barra 'pizza' personalizzata, verrà visualizzato in Big Wigs."
...
--L["FLASH_desc"] = "Alcune abilità sono più importanti di altre. Se vuoi che lo schermo lampeggi quando qiesta abilità sta per essere lanciata o è usata, seleziona questa opzione."
...
L["PING_desc"] = "A volte le posizioni sono importanti; Big Wigs punterà sulla minimappa il punto dove alcuni giocatori si trovano."
...
--L["DISPEL_MAGIC"] = "Solo Dissolutori Magici"
--L["DISPEL_MAGIC_desc"] = "Se vuoi vedere gli avvertimenti per queste abilità anche quando non puoi dissiparle, disabilita questa opzione."
--L["DISPEL_ENRAGE"] = "Solo Dissolutori di Rabbia"
--L["DISPEL_ENRAGE_desc"] = "Se vuoi vedere gli avvertimenti per queste abilità anche quando non puoi dissiparle, disabilita questa opzione."
...
--L.dispeller = "Avviso solo per Dissolutori Magici. "
