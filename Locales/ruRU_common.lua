...
L.generalNote = "Текст будет использован по умолчанию"
L.timerNote = "Текст будет использован для таймеров"
L.castTimerNote = "Текст будет использован для таймеров кастов"
L.messageCastOverNote = "Текст будет использован для сообщений при завершении каста"
L.messageCastStartNote = "Текст будет использован для сообщений при начале каста"
L.messageBeforeCastStartNote = "Текст будет использован для сообщений перед началом каста"
L.messageDuringCastNote = "Текст будет использован для сообщений во время каста"
L.messageNote = "Текст будет использован для сообщений"
L.messageOnYouNote = "Сообщение когда эта способность на вас"
L.messageOnOtherNote = "Сообщение когда способонсть на других игроках"
L.messageTauntNowNote = "Сообщение когда вы танк и нужно использовать таунт"
L.messageSpecificHealth = "Сообщение когда босс на %d%% здоровья"
L.timerOnYouNote = "Текст для таймера когда эта способность на вас"
L.mythicOnlyNote = "Текст будет использован только на мифической сложности"
L.otherDifficultiesNote = "Текст будет использован на всех остальных сложностях"
