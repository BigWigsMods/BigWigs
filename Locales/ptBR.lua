...
L.TANK = "Apenas Tanque"
L.TANK_desc = "Algumas habilidades são importantes apenas para tanques. Se você quiser ver avisos para essa habilidade, independentemente do seu papel, desative esta opção."
...
L.TANK_HEALER_desc = "Algumas habilidades são importantes apenas para os tanks e curandeiros. Se você quiser ver avisos para essa habilidade, independentemente do seu papel, desative esta opção."
