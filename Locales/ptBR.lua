...
L.warnTwoReleases = "Seu BigWigs está 2 versões desatualizado! Sua versão provavelmente contém bugs, faltam funcionalidades, ou possui contadores iIcon size of your current targetncorretos. É extremamente recomendado uma atualização."
...
L.oldVersionsInGroup = "Há pessoas com |cffff0000 versões antigas|r do BigWigs. Você pode conseguir mais detalhes usando /bwv."
...
L.outOfDateAddOnRaidWarning = "O |cFF436EEE%s|r addon está desatualizado! You tem v%d.%d.%d a versão mais nova é v%d.%d.%d!"
