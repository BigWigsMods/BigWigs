...
L.keystoneTeleportOnCooldown = "O feitiço de teleporte '|cFFFFFFFF%s|r' está atualmente |cFFFF4411em tempo de recarga|r por %d |4hour:horas; e %d |4minute:minutos;."
...
L.keystoneHideGuildWarning = "Desabilitar a capacidade dos membros da sua guilda de ver sua pedra-chave não é recomendado.\n\nTem certeza de que deseja fazer isso?"
