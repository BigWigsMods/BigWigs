...
L.adds = "Lacaios"
L.adds_desc = "Ativa funções relacionadas aos vários lacaios que aparecerão durante o encontro com o chefe."
L.health = "Vida"
...
L.testNameplate = "Alvo detectado, criando uma barra de identificação teste sobre a barra de identificação do alvo. |cFF33FF99Essa função é raramente usada, normalmente é somente 1 barra, e é necessária para manter o rastreio de recargas quando lutando com múltiplos chefes/lacaios que conjuram a mesma magia.|r"
