...
L.sharing_renames_desc = "Importa os renomes personalizados configurados."
L.sharing_export_renames_desc = "Exporta os renomes personalizados configurados."
...
L.lfgTimerTitle = "Temporizador do PG"
L.lfgTimerExplainer = "Sempre que a janela da fila do PG aparecer, o BigWigs criará uma barra de temporizador informando quanto tempo você tem para aceitar a fila.\n\n"
L.lfgUseMaster = "Reproduzir som de PG pronto no canal de áudio 'Principal'"
L.lfgUseMasterDesc = "Quando esta opção estiver ativada, o som de LFG pronto será reproduzido no canal de áudio 'Principal'. Se você desativar esta opção, ele será reproduzido no canal de áudio '%s' em vez disso."
