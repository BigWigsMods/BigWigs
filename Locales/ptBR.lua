...
L.addonwarningDesc = "Big Wigs e outros addons similares podem mostrar suas mensagens para o grupo pelo canal de raide. Estas mensagens são normalmente mostradas com três estrelas antes (***), essas são as que o BigWigs deve ou não bloqueá-las.\n\n|cffff4411Ativando esta opção, poderá surgir muitos spams e não é recomendável.|r"
...
L.whisperDesc = "Envia um susurro aos jogadores afetados com certas habilidades. Efeitos tipo 'bomba' e similares.\n\n|cffff4411Somente enviará se você for assistente ou líder!|r"
L["Broadcast"] = "Anunciar"
L.broadcastDesc = "Anuncia todos as mensagens do Big Wigs no canal de alerta de raide. \n\n|cffff4411Somente se você for asistente de raide, porém em grupo irá anunciar de qualquer maneira.|r"
L["Raid channel"] = "Canal de raide"
L["Use the raid channel instead of raid warning for broadcasting messages."] = "Usa o canal de raide ao invés do aviso de raide para enviar mensagens."
