...
L.settings_import_bars_desc = "Importa las opciones generales, como tamaño, fuente, etc."
...
L.settings_export_countdown_desc = "Exporta las opciones generales de los contadores the general countdown settings such as voice, size, font, etc."
...
L.sharing_private_auras_desc = "Importa los sonidos configurados de las Auras privadas."
...
L.keystoneHideGuildWarning = "Desactivar la habilidad para que los miembros de tu hermandad vean to piedra angular |cffff4411no es recomendado|r.\n\n¿Estás seguro de querer hacer esto?"
...
L.positionDesc = "Escriba en el recuadro o mueve el deslizador si necesitas un posicionamiento exacto desde el ancla."
L.width = "Anchura"
L.height = "Altura"
L.size = "Tamaño"
...
L.fontSizeDesc = "Ajusta el tamaño de la fuente utilizando el control deslizante o escriba el valor en la casilla que tiene un máximo de 200."
...
L.glow = "Brillo"
L.enableExpireGlow = "Activar el brillo de expiración"
...
L.blizzWarningsAsBigWigsMessages = "Mostrar las advertencias de jefes de Blizzard como mensajes de BigWigs"
L.blizzWarningsAsBigWigsMessagesDesc = "Todas las advertencias de jefes de Blizzard se mostrarán como mensajes de BigWigs."
L.blizzAudioAsBigWigsAudio = "Convertir sonidos de Blizzard a sonidos de BigWigs"
L.blizzAudioAsBigWigsAudioDesc = "Reproduce tus sonidos de BigWigs (Alerta, Alarma y Advertencia) según la severidad de la alerta del encuentro."
L.blizzWarningSettings = "Configuración de Advertencias de Blizzard"
...
L.enableBlizzWarnings = "Activar advertencias de jefes de Blizzard"
L.enableBlizzWarningsDesc = "Al activar las advertencias de jefe de Blizzard también debes desactivar mostrarlas como mensajes de BigWigs, de lo contrario verás todos los mensajes dos veces."
