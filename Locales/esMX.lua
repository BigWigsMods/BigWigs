...
L.spellNameResetDesc = "Esta habilidad tiene un nombre personalizado por defecto, haz clic en este botón para usar el nombre original (normalmente el nombre del hechizo)."
