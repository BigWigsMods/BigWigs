...
--L.sharing_auras_desc = "Import the configured Auras sounds."
...
L.theOtherTankDesc = "Muestra las auras privadas en el primer tanque de tu grupo que no seas tú. (Actual: %s)"
