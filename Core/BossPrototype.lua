...
do
	...
	function UpdateDispelStatus()
		...
		if IsSpellKnown(527) or IsSpellKnown(77130) or IsSpellKnown(115450) or IsSpellKnown(4987) or IsSpellKnown(88423) or IsPlayerSpell(360823) then -- XXX Add DPS priest mass dispel?
