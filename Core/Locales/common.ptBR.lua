...
--L.wave_count = "Onda %d de %d" -- Onda 1 de 3 (Usually waves of adds)
...
--L.remaining = "%d restante" -- 5 remaining
...
--L.link_say_option_name = "Repetindo mensagens de 'Ligado'"
--L.link_say_option_desc = "Repetindo mensagens no chat dizendo com quem você está ligado."
