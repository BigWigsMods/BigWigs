...
if L then
	...
	L.freeze_trigger1 = "замедлен!!"
	L.freeze_trigger2 = "заморожен!"
	L.freeze_trigger3 = "тело" -- CHECK
	L.freeze_trigger4 = "Начинает трескаться!"
	L.freeze_trigger5 = "Скоро разобьётся на части!!"
