...
if L then
	L.macabre_start_emote = "auf Eure Plätze! Der Totentanz beginnt!" -- [RAID_BOSS_EMOTE] Take your places for the Danse Macabre!#Dance Controller#4#false"
	-- yell2 "Alle herhören! Aufstellung zum Totentanz!"
	-- yell3 "Alle auf ihre Positionen! Es ist Zeit für den Totentanz!"
