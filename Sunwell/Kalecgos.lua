...
function mod:ProcessCombatLog(_, event, _, _, _, _, player, _, spellID, spellName)
	...
	elseif event == "SPELL_AURA_APPLIED" then
		...
		elseif spellID == 45032 or spellID == 45034 then -- Curse of Boundless Agony x2 ID's
			self:Sync("KalecgosCurse", player)
		elseif spellID == 44978 and player == pName and db.magichealing then -- Wild Magic - Healing done by spells and effects increased by 100%.
	...
	elseif event == "SPELL_AURA_REMOVED" and (spellID == 45032 or spellID == 45034) then --Curse of Boundless Agony x2 ID's
