...
local timersEasy = {
	[1] = {
		[1230087] = {25.0, 50.0, 50.0}, -- Massive Smash
		[1229038] = {12.5, 100.0}, -- Devour (P1)
		[1230979] = {37.5, 46.3, 53.7}, -- Dark Matter
		[1243690] = {43.7, 50.0, 50.0}, -- Shattered Space
		[1243577] = {56.3, 45.0, 55.0}, -- Reverse Gravity
	},
	[3] = {
		[1233539] = {47.3, 100.0}, -- Devour (P3)
