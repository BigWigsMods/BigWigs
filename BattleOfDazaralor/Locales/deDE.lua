local L = BigWigs:NewBossLocale("Conclave of the Chosen", "deDE")
if not L then return end
if L then
	L.killed = "%s getötet!"
end

local L = BigWigs:NewBossLocale("Flamefist and the Illuminated", "deDE")
if not L then return end
if L then
...
L = BigWigs:NewBossLocale("Grimfang and Firecaller", "deDE")
if L then
	--L.custom_on_fixate_plates = "Stalking icon on Enemy Nameplate"
	--L.custom_on_fixate_plates_desc = "Show an icon on the target nameplate that is stalking on you.\nRequires the use of Enemy Nameplates. This feature is currently only supported by KuiNameplates."
...
L = BigWigs:NewBossLocale("Treasure Guardian", "deDE")
if L then
