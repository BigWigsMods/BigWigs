local L = BigWigs:NewBossLocale("Vexie and the Geargrinders", "frFR")
if not L then return end
if L then
	L.plating_removed = "%d Plaque protectrice restante(s)"
	L.exhaust_fumes = "Dégâts sur le raid"
end
...
if L then
	...
	L.voltaic_image = "Fixations" -- Multiple of Fixate
end
