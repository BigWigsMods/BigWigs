...
L.redirectPopups = "重定向彈出式橫幅到BigWigs訊息"
L.redirectPopupsDesc = "螢幕中間的彈出式橫幅，如'|cFF33FF99寶庫欄位已解鎖|r' 橫幅或進入大秘境副本時看到的橫幅，將被阻擋並顯示為BigWigs訊息。這些橫幅可能很大，持續時間很長，而且會阻止你點擊通過。"
L.redirectPopupsColor = "重定向訊息的顏色"
L.blockDungeonPopups = "阻擋地下城彈出式橫幅"
L.blockDungeonPopupsDesc = "進入地下城時彈出的橫幅有時會包含很長的文字。啟用此功能將完全阻擋它們，而不是重新顯示到BigWigs訊息內。"
