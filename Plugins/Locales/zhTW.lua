...
L.countdownAt_desc = "選擇開始播報倒數計時的閾值，當首領技能低於此秒數就會開始倒數（以秒為單位）。"
L.countdown = "倒數"
...
L.countdownBegins_desc = "選擇在開怪計時器上倒數開始時應剩餘多少時間（以秒為單位）。"

-----------------------------------------------------------------------
-- Sound.lua
--

L.soundsDesc = "BigWigs 使用“主音量”通道播放全部音效。如果發現音效過小或過大，打開游戲聲音設置並調整“主音量”捲動軸到所需的等級。"
L.oldSounds = "傳統音效設定"
