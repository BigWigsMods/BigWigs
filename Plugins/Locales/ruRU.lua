...
L["Temporarily Super Emphasizes the bar and any messages associated with it for the duration."] = "Временное супер увеличение полос и всех сообщений, связанных с ним в течение всего срока действия."
L["Report"] = "Сообщить"
