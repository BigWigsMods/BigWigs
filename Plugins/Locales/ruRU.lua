...
L.pullName = "Таймер атаки"
L.pullCountType = "Вид отсчета"
L.pullNormal = "Обычный"
L.pullEmphasized = "Увеличенный"
L.pullCombatlog = "Автоматическая запись лога боя"
L.pullCombatlogDescription = "Автоматически начинать запись лога боя после запуска таймера атаки и останавливать запись после завершения боя."
L.pullGearCheck = "Проверка плохой экипировки"
L.pullGearCheckDescription = "После запуска таймера атаки ваша экипировка будет просканирована на предмет потенциально \"плохих\" вещей."