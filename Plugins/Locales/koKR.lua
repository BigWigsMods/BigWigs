...
L.customBarStarted = "%2$s 사용자 %3$s|1이;가; '%1$s' 사용자 설정 바 시작함."
...
L.wrongTime = "유효하지 않은 시간이 지정되었습니다. <시간>은 초 단위 숫자, 분:초 형식, 또는 M분으로 입력할 수 있습니다. 예제 5, 1:20 또는 2m."

L.wrongBreakFormat = "1분에서 60분 사이여야 합니다. 올바른 예제: /break 5"
L.sendBreak = "BigWigs와 DBM 사용자에게 휴식 타이머를 보냅니다."
L.breakStarted = "%s 사용자 %s|1이;가; 휴식 타이머 시작함."
L.breakStopped = "%s|1이;가; 휴식 타이머 취소함."
L.breakBar = "휴식 시간"
...
L.combatLogDesc = "전투 예정 타이머의 시작과 우두머리 전투 종료로 타이머가 종료될 때 자동으로 전투 기록을 시작합니다."

L.pull = "전투 예정"
L.pulling = "전투 시작!"
L.pullStarted = "%s 사용자 %s|1이;가; 전투 예정 타이머 시작함."
L.pullStopped = "%s|1이;가; 전투 예정 타이머 취소함."
L.pullIn = "%d초 후 전투 시작"
