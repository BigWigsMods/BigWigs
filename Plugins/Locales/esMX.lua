...
L.blockZoneChangesDesc = "Los mensajes que se muestran en la parte media superior de la pantalla cuando te mueves a una nueva zona, como '|cFF33FF99Ventormenta|r' o '|cFF33FF99Orgrimmar|r', se bloquearán."
L.audio = "Audio"
L.music = "Música"
...
L.redirectPopupsDesc = "Las banderas emergentes en el medio de la pantalla, como la bandera '|cFF33FF99ranura de la gran cámara desbloqueada|r' o la bandera que ves al entrar a una calabozo Mítico+, se bloquearán y se mostrarán como mensajes de BigWigs. Estas banderas pueden ser bastante grandes, durar mucho tiempo y bloquear la posibilidad de hacer clic en ellos."
L.redirectPopupsColor = "Color del mensaje redirigido"
L.blockDungeonPopups = "Bloquear banderas emergentes de calabozos"
L.blockDungeonPopupsDesc = "Las banderas emergentes que se muestran al entrar a una calabozo a veces pueden contener texto muy largo. Activar esta función los bloqueará completamente en lugar de ser redirigidos a los mensajes de BigWigs."
