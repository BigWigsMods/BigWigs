...
L.blockZoneChangesDesc = "I messaggi mostrati al centro in alto dello schermo quando ti muovi in una nuova zona come '|cFF33FF99Stormwind|r' o '|cFF33FF99Orgrimmar|r' saranno bloccati."
L.audio = "Audio"
L.music = "Musica"
...
L.redirectPopupsDesc = "I banner popup come Popup '|cFF33FF99vault slot unlocked|r' o il banner che vedi quando entri in un dungeon mitica+ saranno bloccati e visualizzati come messaggi di Bigwigs. Questi banner possono essere abbastanza grandi, durare molto, e bloccare la possibilità di cliccarci attraverso."
