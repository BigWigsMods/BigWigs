...
L.redirectPopupsDesc = "I banner popup in mezzo al tuo schermo per esempio '|cFF33FF99vault slot unlocked|r' verrano invece visualizzati come messaggi BigWigs. Questi banner possono essere abbastanza grandi, durare molto, e bloccare la possibilità di cliccarci attraverso."
