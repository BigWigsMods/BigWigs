...
L["Must be between 1 and 10. A correct example is: /pull 5"] = "必须位于1到10之间。正确用法：/pull 5"
L["Incorrect format. A correct example is: /bwcb 20 text"] = "错误格式。正确用法：/bwcb 20 文本"
