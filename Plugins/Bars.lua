...
do
	-- Aurora style (classic version), half height bar and shadow border

	local backdropBorder = {
		bgFile = "Interface\\Buttons\\WHITE8X8",
		edgeFile = "Interface\\AddOns\\BigWigs\\Media\\Textures\\glow",
	...
	local function styleBar(bar)
		...
		bd:SetBackdropColor(.15, .15, .15, .4)
	...
	barStyles.Aurora = {
		...
		GetStyleName = function() return "Aurora" end,
	}
end
