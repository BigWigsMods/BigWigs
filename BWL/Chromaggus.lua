BigWigsChromaggus = AceAddon:new({
	...
	{
		bossname = "å…‹æ´›çŽ›å¤æ–¯",
		disabletrigger = "å…‹æ´›çŽ›å¤æ–¯æ­»äº¡äº†ã€‚",

		trigger1 = "^å…‹æ´›çŽ›å¤æ–¯å¼€å§‹æ–½æ”¾(.+)ã€‚",
		trigger2 = "^.+çš„(.+)å…‹æ´›çŽ›å¤æ–¯é€ æˆ(%d+)ç‚¹(.+)ä¼¤å®³ã€‚",
		trigger3 = "^å…‹æ´›çŽ›å¤æ–¯çš„æ—¶é—´æµé€è¢«(.+)æŠµæŠ—äº†ã€‚",
		trigger4 = "å˜å¾—æžä¸ºç‹‚æš´ï¼",
		trigger5 = "çš„çš®è‚¤é—ªç€å…‰èŠ’",

		hit = "å‡»ä¸­",
		crit = "è‡´å‘½ä¸€å‡»",

		warn1 = "%s - 10ç§’åŽæ–½æ”¾ï¼",
		warn2 = "æ­£åœ¨æ–½æ”¾ %sï¼",
		warn3 = "æ–°æ³•æœ¯å¼±ç‚¹ï¼š%s",
		warn4 = "æ³•æœ¯å¼±ç‚¹å·²æ”¹å˜ï¼",
		warn5 = "ç‹‚æš´è­¦æŠ¥ - çŒŽäººç«‹åˆ»ä½¿ç”¨å®ç¥žå°„å‡»ï¼",
		bosskill = "å…‹æ´›çŽ›å¤æ–¯è¢«å‡»è´¥äº†ï¼",

		breathsicons = {
			["æ—¶é—´æµé€"] = "Interface\\Icons\\Spell_Arcane_PortalOrgrimmar",
			["è…èš€é…¸æ¶²"] = "Interface\\Icons\\Spell_Nature_Acid_01",
			["Ignite Flesh"] = "Interface\\Icons\\Spell_Fire_Fire",
			["Incinerate"] = "Interface\\Icons\\Spell_Shadow_ChillTouch",
			["å†°éœœç¼çƒ§"] = "Interface\\Icons\\Spell_Frost_ChillingBlast",
		}
	}	or {
		bossname = "Chromaggus",
