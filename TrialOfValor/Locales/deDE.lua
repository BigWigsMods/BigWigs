...
if L then
	L.nearTrigger = "|TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t Ein %s erscheint in Helyas Nähe!" -- |TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t A %s emerges near Helya! -- Translate this comment with the emote
	L.farTrigger = "|TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t Ein %s erscheint weit von Helya entfernt!" -- |TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t A %s emerges far from Helya! -- Translate this comment with the emote
