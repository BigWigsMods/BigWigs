...
if L then
	L.nearTrigger = "|TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t一头强击触须出现在海拉的附近！"
	L.farTrigger = "|TInterface\\Icons\\inv_misc_monsterhorn_03.blp:20|t一头强击触须出现在海拉的远处！"
