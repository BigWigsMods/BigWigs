...
if L then
	...
	L.yellow_spawn_trigger = "Яркий свет высвечивает лазурный туман!"
	...
	L.custom_off_ray_controllers_desc = "Использовать %s%s%s метки для обозначения людей, контролирующих лучи."
