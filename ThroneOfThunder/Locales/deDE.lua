...
if L then
	...
	L.storm_duration_desc = "Eine seperate Leiste für die Dauer von Gewittersturm"
...
if L then
	...
	L.loa_spirit = "Loa Geist"
	L.loa_spirits = "Loa Geister"
	L.loa_spirits_desc = "Warnung für beide Arten von Loa Geister adds"
end
...
if L then
	L.conduit_abilities = "Leiter-Fähigkeiten"
	L.conduit_abilities_desc = "Ungefähre Cooldown-Leisten für die spezifischen Fähigkeiten der Leiter"
	
	L.conduit_ability_meassage = "Nächste Leiter-Fähigkeit"
	L.intermission = "Unterbrechung"
	L.overchargerd_message = "Betäubender AoE Puls"
	L.static_shock_message = "Aufteilender AoE Schaden"
	L.diffusion_add_message = "Wetterleucht-Elementare"
	L.diffusion_chain_message = "Wetterleucht-Elementare bald - VERTEILEN!"
end
