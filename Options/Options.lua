...
local superEmphasizeOptions = {
	...
	args = {
		heading = {
			type = "description",
			name = "Boosts related messages or bars of a specific boss encounter ability. In this panel you can configure what exactly should happen when you toggle on the Super Emphasize option in the advanced section for a particular boss encounter ability.\n\n|cffff4411Note that Super Emphasize is off by default for all abilities.|r\n",
			order = 10,
			width = "full",
			fontSize = "medium",
		},
