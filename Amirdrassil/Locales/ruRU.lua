...
if L then
	...
	L.falling_stars = "Звёзды"
	L.falling_stars_single = "Звезда"
...
if L then
	L.firestorm = "Метеориты"
	L.dream_rend = "Притягивание"
	L.fyralaths_bite = "Танкбастер"
	L.fyralaths_mark = "Метка"
	L.incarnate = "Подкидка"
	L.shadowflame_devastation = "Deep Breath"
	L.greater_firestorm = "Метеориты" -- "B" for both greater and eternal in ru translation, also pointless distinction
	L.eternal_firestorm = "Метеориты" -- see above
end

L = BigWigs:NewBossLocale("Amirdrassil, the Dream's Hope Trash", "ruRU")
if L then
end
