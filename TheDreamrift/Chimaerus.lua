...
mod:SetPrivateAuraSounds({
	{1245698, "info"}, -- Alnsight
	-- 1253744, -- Rift Vulnerability (Applied at the same time as Alnsight)
	{1250953, "alert"}, -- Rift Sickness
	-- 1262020, -- Colossal Strikes, Used?
	{1265940, "alarm"}, -- Fearsome Cry
	1264756, -- Rift Madness
	1257087, -- Consuming Miasma
	{1258192, "alert"}, -- Lingering Miasma
	{1246653, "alert"}, -- Caustic Phelgm
	{1272726, "alarm"}, -- Rending Tear
})
